...
- (void) awakeFromNib {
	...
	self.topLeftHandle = CGRectMake(0,0,25,25);
	self.bottomRightHandle = CGRectMake(self.bounds.size.width-25,self.bounds.size.height-25,25,25);
...
- (void) mouseDragged:(NSEvent *)theEvent {
	...
	if(self.currentHandle == LeftHandleId) {
		...
		self.topLeftHandle = CGRectMake(leftHandlePoint.x, leftHandlePoint.y, 25, 25);
	...
	if(self.currentHandle == RightHandleId) {
		...
		self.bottomRightHandle = CGRectMake(leftHandlePoint.x, leftHandlePoint.y, 25, 25);
	...
	CGFloat width = (self.bottomRightHandle.origin.x - self.topLeftHandle.origin.x) + 25;
	CGFloat height = (self.bottomRightHandle.origin.y - self.topLeftHandle.origin.y) + 25;
